...
def create_player_query(club):
  start_query = '''SELECT DISTINCT ?item ?itemLabel ?team ?pays_de_nationalité_sportive ?pays_de_nationalité_sportiveLabel ?date_de_naissance WHERE{
...
def get_player_id():
  ...
  #players_id = list_q(result_query_player)
